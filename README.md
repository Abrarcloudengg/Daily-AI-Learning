...
| 🎯 **Current topic** | Function Arguments |
| 📅 **Next lesson** | Day 17 of Python |
| 📈 **Subject progress** | 16/114 · 14.0% |
| ✅ **Lessons written** | 16/740 |
| 📦 **Subjects finished** | 0/15 |
| 🗂️ **Files on disk** | 16 Markdown lessons |
...
|---:|---|---|---:|---|---|
| 1 | **Python** | 🚀 In progress | 16/114 | `██░░░░░░░░░░` | [`Python/`](generated/Python) |
