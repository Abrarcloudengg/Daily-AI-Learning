...
| 🎯 **Current topic** | Keyword Arguments |
| 📅 **Next lesson** | Day 19 of Python |
| 📈 **Subject progress** | 18/114 · 15.8% |
| ✅ **Lessons written** | 18/740 |
| 📦 **Subjects finished** | 0/15 |
| 🗂️ **Files on disk** | 18 Markdown lessons |
...
|---:|---|---|---:|---|---|
| 1 | **Python** | 🚀 In progress | 18/114 | `██░░░░░░░░░░` | [`Python/`](generated/Python) |
