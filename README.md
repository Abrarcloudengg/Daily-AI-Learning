...
| 🎯 **Current topic** | Default Arguments |
| 📅 **Next lesson** | Day 18 of Python |
| 📈 **Subject progress** | 17/114 · 14.9% |
| ✅ **Lessons written** | 17/740 |
| 📦 **Subjects finished** | 0/15 |
| 🗂️ **Files on disk** | 17 Markdown lessons |
...
|---:|---|---|---:|---|---|
| 1 | **Python** | 🚀 In progress | 17/114 | `██░░░░░░░░░░` | [`Python/`](generated/Python) |
