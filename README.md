...
| 📅 **Next lesson** | Day 11 of Python |
| 📈 **Subject progress** | 10/114 · 8.8% |
| ✅ **Lessons written** | 10/740 |
| 📦 **Subjects finished** | 0/15 |
| 🗂️ **Files on disk** | 10 Markdown lessons |
...
|---:|---|---|---:|---|---|
| 1 | **Python** | 🚀 In progress | 10/114 | `█░░░░░░░░░░░` | [`Python/`](generated/Python) |
