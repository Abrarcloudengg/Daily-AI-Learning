...
| 🎯 **Current topic** | Scope (Local and Global) |
| 📅 **Next lesson** | Day 23 of Python |
| 📈 **Subject progress** | 22/114 · 19.3% |
| ✅ **Lessons written** | 22/740 |
| 📦 **Subjects finished** | 0/15 |
| 🗂️ **Files on disk** | 22 Markdown lessons |
...
|---:|---|---|---:|---|---|
| 1 | **Python** | 🚀 In progress | 22/114 | `██░░░░░░░░░░` | [`Python/`](generated/Python) |
