...
| 🎯 **Current topic** | Break Statement |
| 📅 **Next lesson** | Day 12 of Python |
| 📈 **Subject progress** | 11/114 · 9.6% |
| ✅ **Lessons written** | 11/740 |
| 📦 **Subjects finished** | 0/15 |
| 🗂️ **Files on disk** | 11 Markdown lessons |
...
|---:|---|---|---:|---|---|
| 1 | **Python** | 🚀 In progress | 11/114 | `█░░░░░░░░░░░` | [`Python/`](generated/Python) |
