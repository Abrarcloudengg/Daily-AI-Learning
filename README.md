...
| 🎯 **Current topic** | While Loop |
| 📅 **Next lesson** | Day 10 of Python |
| 📈 **Subject progress** | 9/114 · 7.9% |
| ✅ **Lessons written** | 9/724 |
| 📦 **Subjects finished** | 0/15 |
| 🗂️ **Files on disk** | 9 Markdown lessons |
...
|---:|---|---|---:|---|---|
| 1 | **Python** | 🚀 In progress | 9/114 | `█░░░░░░░░░░░` | [`Python/`](generated/Python) |
