...
| 🎯 **Current topic** | Lambda Functions |
| 📅 **Next lesson** | Day 21 of Python |
| 📈 **Subject progress** | 20/114 · 17.5% |
| ✅ **Lessons written** | 20/740 |
| 📦 **Subjects finished** | 0/15 |
| 🗂️ **Files on disk** | 20 Markdown lessons |
...
|---:|---|---|---:|---|---|
| 1 | **Python** | 🚀 In progress | 20/114 | `██░░░░░░░░░░` | [`Python/`](generated/Python) |
