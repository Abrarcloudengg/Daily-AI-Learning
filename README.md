...
| 🎯 **Current topic** | Variable Length Arguments |
| 📅 **Next lesson** | Day 20 of Python |
| 📈 **Subject progress** | 19/114 · 16.7% |
| ✅ **Lessons written** | 19/740 |
| 📦 **Subjects finished** | 0/15 |
| 🗂️ **Files on disk** | 19 Markdown lessons |
...
|---:|---|---|---:|---|---|
| 1 | **Python** | 🚀 In progress | 19/114 | `██░░░░░░░░░░` | [`Python/`](generated/Python) |
